...
public class PullToRefreshSwipeListFragment extends PullToRefreshBaseListFragment<PullToRefreshSwipeListView> {
	...
	protected PullToRefreshSwipeListView onCreatePullToRefreshListView(LayoutInflater inflater, Bundle savedInstanceState) {
		return new PullToRefreshSwipeListView(getActivity());
	}
